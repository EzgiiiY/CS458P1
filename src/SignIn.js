        ...
        return (
            <Card bordered={false} style={{ "backgroundColor": "#00000000" }} >
                <div className="hybrid-login-form" >
                    ...
                    <p style={{ fontWeight: "500", fontSize: "16px", marginTop: "2%", color: "#b3b3b3" }}>New to Netflix? <Link to="/signup" style={{ color: "#fff" }}>Sign Up Now</Link></p>
            ...
            //make the learn more part hidden
        );
    }
};
